...
**Digital Cards** are identity credentials issued to people's phones via Google Wallet. Unlike physical ID cards, digital cards don't require printing — recipients tap a link to add their ID to their wallet.
