...
<Columns cols={2}>
  <Card title="Save to Master List" icon="arrows-rotate" href="/getting-started/key-concepts#saving-to-master-list">
    Push approved photos and data changes back to your Master List for safekeeping.
  </Card>
  <Card title="Print ID cards" icon="id-card" href="/getting-started/key-concepts#card-templates-1">
