...
Password rules are checked as you type, and the rules shown are the same ones the server enforces. If the form accepts your password, it will be accepted when you submit — you will not be told it is fine and then rejected.

For an extra layer beyond the password, see [Two-Factor Authentication](/admin-guide/two-factor-authentication).
