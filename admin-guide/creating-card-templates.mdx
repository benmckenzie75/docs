...
Templates can be renamed at any time from the template list. The name is a label for your team — renaming does not affect cards already issued, or which lists the template is assigned to.
