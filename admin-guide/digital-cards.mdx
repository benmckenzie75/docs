---
title: "Digital ID Cards (Google Wallet)"
description: "Issue digital ID cards via Google Wallet — design a pass template, generate passes for your people, and distribute them by email."
---

Digital Cards let you issue identity credentials directly to people's phones via **Google Wallet**. No app to install, no account to create — recipients simply tap a link to add their ID to their wallet.
...
4. Each person receives an email with an **"Add to Google Wallet"** button
...
Revoked passes move to the "Expired Passes" section in the recipient's Google Wallet. You can **reinstate** a revoked pass if needed.
...
<Info>
Regeneration creates a new pass. Recipients who previously added the pass to their wallet will need to add the new one. The old pass remains until they remove it manually.
</Info>
