...
<Frame caption="The mobile data entry form showing the person header, read-only context fields, and editable input fields">
  <img src="/images/capturer-guide/data-entry-form.png" alt="Mobile data entry screen with person name at top, read-only department field, and editable phone number and email fields" style={{maxWidth: '300px'}} />
</Frame>
...
<Frame caption="Revision notes banner displayed at the top of the data entry form with the admin's feedback message">
  <img src="/images/capturer-guide/data-entry-revision-banner.png" alt="Mobile data entry screen showing an amber revision notes banner at the top with admin feedback text" style={{maxWidth: '300px'}} />
</Frame>
